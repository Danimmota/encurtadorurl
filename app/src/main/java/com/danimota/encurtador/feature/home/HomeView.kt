package com.danimota.encurtador.feature.home
                ...
                onShortenClick = {
                    coroutineScope.launch {
                        ...
                        try {
                            ...
                            Log.d(
                                "UrlShortener",
                                "URL encurtada com sucesso: ${response.alias}"
                            )

                            lastUrlEncurted = response.links.short
                            ...
                            Log.e(
                                "UrlShortener",
                                "Falha ao encurtar URL: ${e.message}"
                            )
